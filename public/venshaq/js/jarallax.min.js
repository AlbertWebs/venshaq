            ...
            w = (function () {
                function s(e, t) {
                    ...
                    l && "object" === u(l) && void 0 !== l.length && (l = c(l, 1)[0]),
                        ...
                        (n.image = { src: n.options.imgSrc || null, $container: null, useImgTag: !1, position: /iPad|iPhone|iPod|Android/.test(p.userAgent) ? "absolute" : "fixed" }),
                            ...
                            value: function (e) {
                                ...
                                p.options.elementInViewport && (y = p.options.elementInViewport.getBoundingClientRect()),
                                    ...
                                    (e || p.isElementInViewport) &&
                                        ...
                                        ("opacity" !== p.options.type && "scale-opacity" !== p.options.type && "scroll-opacity" !== p.options.type) || ((g.transform = "translate3d(0,0,0)"), (g.opacity = s)),
                                        ("scale" !== p.options.type && "scale-opacity" !== p.options.type) ||
                                            ((c = 1), p.options.speed < 0 ? (c -= p.options.speed * s) : (c += p.options.speed * (1 - s)), (g.transform = "scale(".concat(c, ") translate3d(0,0,0)"))),
                                        ("scroll" !== p.options.type && "scroll-opacity" !== p.options.type) ||
                                            ((u = p.parallaxScrollDistance * l), "absolute" === p.image.position && (u -= m), (g.transform = "translate3d(0,".concat(u, "px,0)"))),
                                        p.css(p.image.$item, g),
                                        p.options.onScroll &&
                                            p.options.onScroll.call(p, { section: d, beforeTop: t, beforeTopEnd: n, afterTop: o, beforeBottom: i, beforeBottomEnd: a, afterBottom: r, visiblePercent: s, fromViewportCenter: l }));
                            },
                        },
                        {
                            key: "onResize",
